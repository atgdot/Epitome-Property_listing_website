  ...
  return (
    <div>
      ...
      <div className="w-full py-2 px-5">
        ...
        {/* Card Container */}
        <div className="bg-white border lg:w-[80%] border-gray-200 shadow-lg rounded-xl p-6 flex flex-col lg:flex-row items-center justify-between  mx-auto">

          {/* Left: Images Section */}
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 w-full">
          ...
          <div className="w-full lg:w-1/2 lg:pl-8 mt-4 lg:mt-0">
            ...
            {/* Explore Button */}
            <button className="bg-orange-500 text-white px-6 py-2 rounded-lg font-semibold w-full sm:w-auto">
              Explore Now
            </button>
          </div>
